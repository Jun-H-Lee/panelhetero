...
#' \item{mean_ci_func}{function that returns 95% bootstrap confidence interval for TOJ empirical CDF estimates for the mean}
#' \item{acov_ci_func}{function that returns 95% bootstrap confidence interval for TOJ empirical CDF estimates for the autocovariance}
#' \item{acor_ci_func}{function that returns 95% bootstrap confidence interval for TOJ empirical CDF estimates for the autocorrelation}
